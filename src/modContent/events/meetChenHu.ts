...
import {demonicCultivatorI} from '../monsters/demonicCultivatorILate';
import { chenHuMet, chenHuName } from '../characters/chenHu/chenHuFlags';
import image from '../../assets/image.png'

const chenHuHelp: Buff = {
  name: 'Partner',
  icon: image,
  canStack: false,
  stats: {
      ...
      choices: [
        {
          ...
          children: [
            ...
            },
            {
              kind: 'combat',
              enemies: [
                demonicCultivatorI, demonicCultivatorI
              ],
              ...
              victory: [
                ...
                },
                {
                  kind: 'speech',
                  character: chenHuName,
                  text: 'That was too easy. Thank you junior brother, your strength is amazing, although it is a little short of mine. I\'m Chen Hu, a disciple of the Nine Mountain Sect.'
                },
                {
                  kind: 'approval',
                  character: chenHuName,
              ...
              defeat: [
                ...
                },
                {
                  kind: 'speech',
                  character: chenHuName,
                  text: 'Phew, that was tough, we barely survived. Thanks for the help, junior brother! I\'m Chen Hu, a disciple of the Nine Mountain Sect.'
                },
                {
                  kind: 'approval',
                  character: chenHuName,
            ...
            },
            {
              kind: 'speech',
              character: chenHuName,
              text: 'Heh, let\'s talk in the sect, brother. The others will be here soon, and I think I saw someone at the Qi Condensation realm among them.'
            },
            {
              kind: 'flag',
              global: true,
